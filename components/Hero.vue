<template>
  <div class="w-full text-white flex mb-32 lg:mb-64">
    ...
    >
      <span class="text-4xl lg:text-6xl font-hibana mb-4 lg:mb-2">Welcome!</span>
      ...
      <div class="flex h-full items-center justify-center mt-8 lg:mt-0 lg:absolute lg:left-0 pointer-events-none">
        <span class="text-app-gray-3 font-bold text-lg transform lg:-rotate-90 lg:-translate-x-32 lg:-translate-y-10">contact@limelight.com</span>
      </div>
    </div>
  </div>
</template>
