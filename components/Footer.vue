<template>
  ...
  >
    ...
    >
      ...
      <div
        class="text-center font-semibold md:text-md lg:text-xl text-gray-400"
      >
        App pagesLorem ipsum - semper vehicula.
      </div>
    </div>
    <p
      class="hidden sm:flex items-center justify-center font-semibold sm:text-md md:text-lg lg:text-xl text-gray-400"
    >
